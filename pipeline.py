...
project = Project(
    title = 'grab',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://wiki.archiveteam.org/images/thumb/f/f3/Archive_team.png/587px-Archive_team.png" height="50px"/>
    <h2>Archiving specific sites. &middot; <a href="http://tracker.archiveteam.org/grab/">Leaderboard</a></span></h2>
    '''
)
